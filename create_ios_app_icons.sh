...
sips -z 60 60 $SOURCE_IMAGE --out "$DESTINATION_DIR/$IMAGE_NAME-20@3x.png"
...
sips -z 87 87 $SOURCE_IMAGE --out "$DESTINATION_DIR/$IMAGE_NAME-29@3x.png"
...
sips -z 120 120 $SOURCE_IMAGE --out "$DESTINATION_DIR/$IMAGE_NAME-40@3x.png"
...
sips -z 57 57 $SOURCE_IMAGE --out "$DESTINATION_DIR/$IMAGE_NAME-57.png"
sips -z 114 114 $SOURCE_IMAGE --out "$DESTINATION_DIR/$IMAGE_NAME-57@2x.png"

sips -z 120 120 $SOURCE_IMAGE --out "$DESTINATION_DIR/$IMAGE_NAME-60@2x.png"
sips -z 180 180 $SOURCE_IMAGE --out "$DESTINATION_DIR/$IMAGE_NAME-60@3x.png"
...
sips -z 1024 1024 $SOURCE_IMAGE --out "$DESTINATION_DIR/$IMAGE_NAME-1024.png"
